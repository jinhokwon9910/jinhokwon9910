...
1. **J. Kwon**, J. Jung, et al., "A Multi-Modal Simulator for Aerial Communication with Applications to Beam Search," *ICTC*, Jeju, Korea, 2025, pp. 524–525. — **제1저자**
2. **J. Kwon**, J. Jeon, et al., "Denoising Diffusion Probabilistic Models for Channel Estimation," *ICTC*, 2024. — **제1저자**
3. J. Jung, **J. Kwon**, et al., "A Multi-Sensor Simulator for UAV Localization: Kalman Filter-Based Approach," *ICTC*, Jeju, Korea, 2025, pp. 2095–2096.
...
1. **권진호**, 황석준, 서경식, 전정원, 노송, "밀리미터파 대역 지능형 반사 표면 기반 채널 추정 기술 분석," 한국통신학회 동계종합학술발표회, 2023.
2. **권진호**, 전정원, 황석준, 노송, "통합 센싱 및 통신 시스템 기반 레이더 지원 빔탐색 기법," 한국통신학회 하계종합학술발표회, 2023.
3. **권진호**, 노송, "FMCW 레이더 기반 초기 빔포밍 방향 탐색," 한국통신학회 동계종합학술발표회, 2024.
4. **권진호**, 전정원, 정지혁, 노송, "잡음 제거 확산 확률 모델 기반 다중 입력 다중 출력 통신시스템의 채널정제 기법," 한국통신학회 동계종합학술발표회, 2025.
